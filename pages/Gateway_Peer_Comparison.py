...
st.caption(
    ...
    "**% FAFSA** is the share of Grade 12 students who completed the FAFSA "
    "(Free Application for Federal Student Aid), the federal financial-aid "
    "form required for most college grants and loans. "
