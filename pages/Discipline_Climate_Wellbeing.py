"""Discipline, Climate & Wellbeing — suspensions, attendance/absenteeism, and student wellbeing signals."""
...
st.set_page_config(page_title="Discipline, Climate & Wellbeing | LEHS", page_icon="🚸", layout="wide")
sidebar_attribution()
...
with _tab_0:
    # ==== from pages/9_Discipline_and_Climate.py ====
...
with _tab_1:
    ...
    if not youth.empty:
        ...
        "isn't available (see [What We Don't Know](/Methodology)). It's shown here "
        ...
        "see [What We Don't Know](/Methodology)."
        )
    ...
    st.markdown(
        "Related view: the **Discipline & Climate** tab covers "
